...
public class CadastroClientes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/src/8666546_user_plus_icon (5).png"))); // NOI18N
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        try {
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "Esse cliente possui vendas em seu nome");
        }
        setBotoes(0);
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        try {
            ...
            if (email.isEmpty()) {
                javax.swing.JOptionPane.showMessageDialog(this, "E-mail é obrigatório");
                return;
            }
            if (telefone.length() != 15) {
                javax.swing.JOptionPane.showMessageDialog(this, "Telefone inexistente");
                return;
            }
            if (cpf.length() != 14) {
